...
#define STRING_CONFIG_H_AUTHOR "(Vincent S, Ender 5 Pro Dual Z / BLTouch Config 31/03/21 )" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Vincent's Ender 5 Pro"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80,800, 100.5 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45,-10, -2.526 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 20), (Y_MAX_POS - 20), 20 }
